<template>
	<div id="theHR-land-content-right">
		<div class="thetopTab">
			<span @click="changeTab(0)" class="haveHand" :class="spanIsactive == 0 ? 'spanActive':''">HR账号登陆</span>
		...
		<router-link to="/LandReg/theHRForget">
			<p class="theforgetpassword haveHand">忘记密码？</p>
		</router-link>
		<p @click="judge" class="theupload haveHand">登陆啦！</p>
		<p class="thereg">
			<span>还没有账号？</span>
			<span>请</span>
			<router-link to="/LandReg/theHRReg">
				<span class="haveHand thecolor">注册</span>
			</router-link>
		</p>
	</div>
</template>
