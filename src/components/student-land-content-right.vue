<template>
	<div id="student-land-content-right">
		<div class="thetopTab">
			<span @click="changeTab(0)" class="haveHand" :class="spanIsactive == 0 ? 'spanActive':''">学生账号登陆</span>
		...
		<router-link to="/LandReg/studentForget"><p class="theforgetpassword haveHand">忘记密码？</p></router-link>
		<p @click="judge" class="theupload haveHand">登陆啦！</p>
		<p class="thereg">
			<span>还没有账号？</span>
			<span>请</span>
			<router-link to='/LandReg/studentReg'><span class="haveHand thecolor">注册</span></router-link>
		</p>
	</div>
</template>
