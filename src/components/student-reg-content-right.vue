<template>
	<div id="student-reg-content-right">
        <div class="theRegcontent">
            <p class="thep1">学生手机号码注册</p>
            <div class="theinput1">
                <input type="text" placeholder="手机号" @change.prevent="testtel()" v-model="thetelphone"><span @click="getimage" class="thespan haveHand">获取验证码</span>
            </div>
            <div class="theinput2">
